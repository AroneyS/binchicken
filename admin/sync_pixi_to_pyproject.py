...
# Write binchicken.yml
with open(os.path.join(base_dir, "binchicken.yml"), "w") as f:
...
print("binchicken.yml written, with ", len(conda_deps), "dependencies.")
