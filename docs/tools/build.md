...
Build GPU-friendly environments for certain binners in Aviary recovery
  [default: do not]. Must be run on a node with GPU access.
...
**\$ binchicken build \--singlem-metapackage metapackage \--checkm2-db
  CheckM2 \--gtdbtk-db GTDBtk**

create dependency environments and download databases

**\$ binchicken build \--singlem-metapackage metapackage \--checkm2-db
  CheckM2 \--download-databases**
